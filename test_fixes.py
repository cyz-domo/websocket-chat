...
if moment_div:
    ...
    if response.status_code == 200:
        ...
        print(f"Add comment response: {response.text}")
    ...
    if response.status_code == 200:
        ...
        if comment_data.get('status') == 'ok':
            ...
            if response.status_code == 200:
                ...
                print(f"Reply comment response: {response.text}")
        else:
            print("Failed to add comment")
    else:
        print("Failed to add comment due to status code: {response.status_code}")
else:
